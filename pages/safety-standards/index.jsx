...
const SafetyStandards = () => {
  ...
  const safetyStandards = [
    ...
    { id: 3, title: 'First-Class Medical Services', desc: '  Apart from assuring your successful treatment, we also seek to guarantee your treatment at the healthcare facility is enjoyable and comfortable.', list: ['The Availability Of A Patient Guardian', " The Transparency Of The Clinic's Policy, Pricing And Documentation", ' Any Support Regarding Travelling To The Clinic', 'Any Free Extra Services(Consultation, Food, Diagnostics)', 'Flexible Visiting Hours', 'Communication Services Such As The Clinics Website & Social Media Accounts.'], img: firstClassMedical_img.src },
